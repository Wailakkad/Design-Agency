...
const filters = ['ALL', 'WEB DEV', 'MOBILE', 'AI / CHATBOT'];
            ...
            >
              ...
              <div className="p-6 border-t border-white/10">
                <div className="flex items-center justify-between">
                  ...
                  {selectedProject.title !== 'Luma Finance Mobile App' && (
                    <a
                      href={selectedProject.title === 'Natural Baby' ? 'https://rag-chatbot-pied-seven.vercel.app/' : selectedProject.title === 'OPTIC STUDIO' ? 'https://opticien-website-ai-agent-for-custo.vercel.app/' : selectedProject.title === 'Plumbing Services' ? 'https://plumber-jade.vercel.app/' : selectedProject.title === 'Next-Gen Agency' ? 'https://neuro-nexa.vercel.app/' : selectedProject.title === 'Bold Orange' ? 'https://web-agency-landing-page-flame.vercel.app/' : selectedProject.title === 'Soda Brand Store' ? 'https://xoxo-bice.vercel.app/' : 'https://nextjs-ai-fullstack-store.vercel.app/'}
                      target="_blank"
