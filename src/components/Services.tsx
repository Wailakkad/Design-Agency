...
export default function Services() {
  ...
  return (
    <section id="services" className="w-full bg-white py-32 px-10">
      <div className="max-w-7xl mx-auto space-y-20">
        <h2 className="text-[120px] leading-none text-muted-bg select-none font-black tracking-[-8px]">SERVICES</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 border-t border-l border-border">
          {services.map((service) => (
            <motion.div
              key={service.id}
              className="bg-white border-r border-b border-border p-10 relative flex flex-col space-y-12 transition-all group hover:bg-muted-bg/30"
            >
